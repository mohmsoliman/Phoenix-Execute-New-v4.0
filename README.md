...
[![Stars](https://img.shields.io/github/stars/Phoenix-Execute-New-v4.0?style=flat-square)](https://github.com)
...
git clone https://github.com/Phoenix-Execute-New-v4.0.git
cd Phoenix-Execute-New-v4.0
...
Phoenix v4.0 runs fully offline, uses under 40 MB RAM at idle, and ships with more bundled scripts than most alternatives.
...
<p align="center">
  <i>Precision execution, zero compromise. Phoenix v4.0 — built for 2026.</i>
</p>
